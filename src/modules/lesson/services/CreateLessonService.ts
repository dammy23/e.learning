...
class CreateLessonService {
    public async execute({ name, duration, count, course_id,type, description, video_id }: Request): Promise<Lesson> {
        ...
        const lesson = lessonsRepository.create({ name, duration, count, course_id,type, description, video_id });
